...
/** Efter OAuth kan `?next=` være tom streng — `??` erstatter ikke `""`, så `${origin}${""}` blev forsiden. */ function resolvePostAuthPath(raw) {
    const t = raw?.trim();
...
async function GET(request) {
    ...
    if (!code) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/login?error=auth`);
    }
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}${nextPath}`);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__110oz2z._.js.map