...
('landing.app.body', 'en-US', 'Give your team the modern, lightning-fast mobile experience they expect. Instead of zooming in on static PDFs or navigating messy WhatsApp groups, your employees get a sleek, native app with a crystal-clear overview of their shifts right in their pockets. It empowers them to seamlessly request shift swaps, pick up open hours, and manage their work life on the go. With instant push notifications for every update, communication chaos is completely eliminated, ensuring everyone is always connected and on the exact same page.', 'Long descriptive paragraph in employee app value section; keep persuasive tone and operational clarity.'),
('landing.app.body', 'da', 'Giv dit team den moderne, lynhurtige mobiloplevelse, de forventer. I stedet for at zoome ind på statiske PDF''er eller navigere i kaotiske WhatsApp-grupper får medarbejderne en elegant, native app med krystalklart overblik over deres vagter direkte i lommen. Den gør det nemt at anmode om vagtbytte, tage ledige timer og styre arbejdslivet på farten. Med øjeblikkelige pushnotifikationer ved hver opdatering fjernes kommunikationskaos, så alle altid er opdaterede og på samme side.', 'Lang brødtekst i sektionen om medarbejder-appen; bevar salgsfokus og tydelig driftseffekt.'),
...
('landing.compliance.body', 'en-US', 'Start by uploading your Excel schedule, and ShiftBob instantly scans the data to flag any violations, like the mandatory 11-hour daily rest rule. When you roll out the mobile app to your team, the platform acts as a strict gatekeeper, actively blocking staff from swapping or picking up shifts if the change breaks labor laws. Finally, with our full online Autopilot, compliance becomes completely hands-off. The engine automatically generates a 100% compliant schedule from scratch, perfectly balancing legal requirements with your team''s personal preferences before you even review it.', 'Long compliance section paragraph explaining three steps: upload check, app gatekeeping, and full online autopilot generation.'),
('landing.compliance.body', 'da', 'Start med at uploade din Excel-vagtplan, så scanner ShiftBob straks data og markerer overtrædelser, fx den lovpligtige 11-timers daglige hvile. Når du ruller mobilappen ud til teamet, fungerer platformen som en striks gatekeeper og blokerer aktivt medarbejdere fra at bytte eller tage vagter, hvis ændringen bryder arbejdsreglerne. Med vores fulde online Autopilot bliver compliance til sidst helt hands-off. Motoren genererer automatisk en 100% compliant vagtplan fra bunden og balancerer juridiske krav med teamets personlige præferencer, før du overhovedet gennemgår planen.', 'Lang compliance-brødtekst med tre trin: uploadkontrol, app-gatekeeping og fuld online autopilot.'),
