...
('landing.compliance.body', 'en-US', 'Start by uploading your Excel schedule, and ShiftBob instantly scans the data to flag any violations, like the mandatory 11-hour daily rest rule. When you roll out the mobile app to your team, the platform acts as a strict gatekeeper, actively blocking staff from swapping or picking up shifts if the change breaks labor laws. Finally, with our full online Autopilot, compliance becomes completely hands-off. Shiftbob automatically generates a 100% compliant schedule from scratch, perfectly balancing legal requirements with your team''s personal preferences.', 'Compliance paragraph for legal labor-law positioning. Use professional legal terminology in each target language. For the 11-hour rule, prefer the locally correct statutory term (e.g., legal daily rest period / minimum daily rest) rather than literal wording.'),
('landing.compliance.body', 'da', 'Start med at uploade din Excel-vagtplan, så scanner ShiftBob straks data og markerer overtrædelser, fx den lovpligtige 11-timers daglige hvile. Når du ruller mobilappen ud til teamet, fungerer platformen som en striks gatekeeper og blokerer aktivt medarbejdere fra at bytte eller tage vagter, hvis ændringen bryder arbejdsreglerne. Med vores fulde online Autopilot bliver compliance til sidst helt hands-off. Shiftbob genererer automatisk en 100% compliant vagtplan fra bunden og balancerer juridiske krav med teamets personlige præferencer.', 'Compliance-afsnit med juridisk arbejdsretlig positionering. Brug professionel juridisk terminologi i hvert målsprog. For 11-timers-reglen skal den lokalt korrekte lovterm foretrækkes (fx daglig hviletid/minimum daglig hvile) frem for ordret oversættelse.'),
